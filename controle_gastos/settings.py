...
"""
# Este arquivo contém as configurações de todo o seu projeto Django. Você pode configurar opções como configurações de banco de dados, configurações de segurança, configurações de middleware, configurações de aplicativos instalados e muito mais.
